          ...
          <div className=' flex md:flex-row flex-col md:gap-8 gap-5 md:mx-20 px-6 md:py-10 py-3 '>
            ...
            <div className=" flex md:w-3/3">
              <div className="md:py-4">
                <div className="mb-2 ">
                  <span className="mb-1 inline-block text-gray-500 italic text-sm md:text-lg">
                    {data.categoryName}
                  </span>
                ...
                <div className="mb-3 flex flex-col  text-gray-700 md:text-lg text-base font-semibold">
                  <p>  Free Delivery</p>
